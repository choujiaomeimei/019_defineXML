  ...
  <div class="project-list-page">
    ...
    <div class="page-header">
      ...
      <div style="display:flex;gap:10px">
        <el-popconfirm
          title="确定要重置系统吗？将清空所有项目数据(Spec/VLM/CodeList/Methods/Comments/Datasets/Pages等18张表)和上传文件！"
        ...
        >
          <template #reference>
            <el-button type="danger" plain size="small" :loading="resetting">重置系统</el-button>
          </template>
        </el-popconfirm>
    ...
    <!-- 创建项目弹窗 -->
    <el-dialog v-model="dialogVisible" title="创建新项目" width="580px" class="saas-dialog" destroy-on-close>
      <el-form :model="projectForm" :rules="formRules" ref="projectFormRef" label-position="top">
        <el-row :gutter="16">
          <el-col :span="12">
            <el-form-item label="项目ID" prop="projectId">
              <el-input v-model="projectForm.projectId" placeholder="如：P500_MR001" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row :gutter="16">
          <el-col :span="12">
            <el-form-item label="方案编号" prop="protocolNumber">
              <el-input v-model="projectForm.protocolNumber" placeholder="请输入方案编号" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="方案名称" prop="protocolName">
              <el-input v-model="projectForm.protocolName" placeholder="请输入方案名称" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="16">
          <el-col :span="12">
            <el-form-item label="方案版本" prop="protocolVersion">
              <el-input v-model="projectForm.protocolVersion" placeholder="如：1.0" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-form-item label="申办方 / 赞助方" prop="sponsor">
          <el-input v-model="projectForm.sponsor" placeholder="请输入申办方或赞助方名称" />
        </el-form-item>
        <el-form-item label="标准类型" prop="standardTypes">
          <el-checkbox-group v-model="projectForm.standardTypes">
      ...
      <template #footer>
        ...
        <el-button type="primary" @click="confirmCreate" :loading="createLoading" round>创建项目</el-button>
      </template>
    </el-dialog>
  </div>
</template>
